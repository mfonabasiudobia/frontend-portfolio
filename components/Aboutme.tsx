    ...
    <section className={styles.mainWrapper} id="about">
        <div className={styles.innerWrapper}>
            ...
            <div className={styles.right}>
              ...
              <p>What can a "frontend web developer" do, you ask?</p>
              <p>I can conjur a website from nothing into existence, fully formed. I do not use tricks, nor maggics. Just like any manufacturing process would be, I passed through all the learning process from HTML, CSS, Javascript, Jquery, Tailwind, Boostrap, now advanced into Firebase, Gatsby.js, Next.js, React.js, Typescript and many more.</p>

              <p>I can plan, design, build and maintain website myself or as part of a team.</p>

              <p>A frontend developer has no boundaries and when they find one they cross it without hesitation, boldly going into the unknown to return rich for it.</p>
